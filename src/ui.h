...
#define SYSMENU_LABEL_SCRIPT               613
...
#define PAL_EXTRA_STATUS_LABEL_START       (SYSMENU_LABEL_LAUNCHSETTING + 3)
#define STATUS_LABEL_POISONDEF             (PAL_EXTRA_STATUS_LABEL_START + 0)
#define STATUS_LABEL_MONSTERPOWER          (PAL_EXTRA_STATUS_LABEL_START + 1)
#define STATUS_LABEL_STEALITEM             (PAL_EXTRA_STATUS_LABEL_START + 2)
#define STATUS_LABEL_ATKEFFECT             (PAL_EXTRA_STATUS_LABEL_START + 3)
#define STATUS_LABEL_5ELEM                 (PAL_EXTRA_STATUS_LABEL_START + 4)

#define STATUS_LABEL_PUPPET                (PAL_EXTRA_STATUS_LABEL_START + 5)
#define STATUS_LABEL_BRAVE                 (PAL_EXTRA_STATUS_LABEL_START + 6)
#define STATUS_LABEL_PROTECT               (PAL_EXTRA_STATUS_LABEL_START + 7)
#define STATUS_LABEL_HASTE                 (PAL_EXTRA_STATUS_LABEL_START + 8)
#define STATUS_LABEL_DUALATK               (PAL_EXTRA_STATUS_LABEL_START + 9)

#define BUYMENU_LABEL_GAIN                 (PAL_EXTRA_STATUS_LABEL_START + 10)
#define SELLMENU_LABEL_SALE                (PAL_EXTRA_STATUS_LABEL_START + 11)

#define DEVMENU_LABEL_TEAM                 (PAL_EXTRA_STATUS_LABEL_START + 12)
#define DEVMENU_LABEL_BG                   (DEVMENU_LABEL_TEAM   + 1)
#define DEVMENU_LABEL_OBJ                  (DEVMENU_LABEL_TEAM   + 2)
#define DEVMENU_LABEL_SS                   (DEVMENU_LABEL_TEAM   + 3)

#define TEAMMENU_LABEL_LOCK                (DEVMENU_LABEL_TEAM + 4)
#define TEAMMENU_LABEL_JOIN                (TEAMMENU_LABEL_LOCK + 1)
#define TEAMMENU_LABEL_LEAVE               (TEAMMENU_LABEL_LOCK + 2)
#define TEAMMENU_LABEL_LEARN               (TEAMMENU_LABEL_LOCK + 3)
...
// #define DEBUGMENU_LABEL_RGM_VIEWER         (DEBUGMENU_LABEL_BATTLEFIELD - 1 + 4)
// #define DEBUGMENU_LABEL_SSS2_OBJ_VIEWER    (DEBUGMENU_LABEL_BATTLEFIELD - 1 + 5)
// #define DEBUGMENU_LABEL_DATA4_MAGIC        (DEBUGMENU_LABEL_BATTLEFIELD - 1 + 6)
...
#define MERGEMENU_BACKGROUND_FBPNUM        31 // OR 10 as cloud env
