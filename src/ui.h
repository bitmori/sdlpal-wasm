...
// #define DEBUGMENU_LABEL_BATTLEFIELD        (TEAMMENU_LABEL_LOCK + 1)
// #define DEBUGMENU_LABEL_SIM_BATTLE         (TEAMMENU_LABEL_LOCK + 2)
// #define DEBUGMENU_LABEL_MGO_VIEWER         (TEAMMENU_LABEL_LOCK + 3)
// #define DEBUGMENU_LABEL_RGM_VIEWER         (TEAMMENU_LABEL_LOCK + 4)
// #define DEBUGMENU_LABEL_SSS2_OBJ_VIEWER    (TEAMMENU_LABEL_LOCK + 5)
// #define DEBUGMENU_LABEL_DATA4_MAGIC        (TEAMMENU_LABEL_LOCK + 6)
...
#define BUYMENU_LABEL_GAIN                 (TEAMMENU_LABEL_LOCK  + 1)
#define SELLMENU_LABEL_SALE                (BUYMENU_LABEL_GAIN   + 1)
